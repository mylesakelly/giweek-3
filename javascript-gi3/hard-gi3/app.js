...
function createPII(name, ssn) {
  ...
  const person = createPII('Myles Kelly', '123-45-6789');
  console.log(person.getName()); // outputs "Myles Kelly"
  console.log(person.pii); // outputs undefined
  console.log(person.ssn); // outputs undefined
